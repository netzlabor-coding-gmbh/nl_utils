...
class ArrayUtility
{
    ...
    public static function sortByPropertyValues(array $items, string $property, array $values, bool $strict = false): array
    {
        ...
        usort($items, function ($a, $b) use ($property, $values, $strict) {
            $aVal = ObjectAccess::getPropertyPath($a, $property);
            $bVal = ObjectAccess::getPropertyPath($b, $property);
     ...
     * @param bool $assoc
     */
    public static function sortByProperty(array &$array, string $propertyName, bool $asc = true, bool $assoc = false): void
    {
