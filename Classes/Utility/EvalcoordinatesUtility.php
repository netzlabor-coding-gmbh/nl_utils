...
class EvalcoordinatesUtility
{
     ...
     * @return string evaluated and well-formed coordinate
     */
    public static function formatLongitude(string $coordinate): string
    {
     ...
     * @return string evaluated and well-formed coordinate
     */
    public static function formatLatitude(string $coordinate): string
    {
     ...
     * @return string
     */
    protected static function validate(string $coordinate, string $upperRange): string
    {
        if ($coordinate === '') {
            return '.00000000';
        }
